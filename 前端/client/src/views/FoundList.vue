    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column prop="operation" align="center" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-button type="warning" icon="edit" size="small" @click="onEditMoney(scope.row)">编辑1</el-button>
            <el-button type="warning" icon="edit" size="small" @click="onEditMoney(scope.row)">编辑2</el-button>
            <el-button
              type="danger"
              icon="delete"
              size="small"
...
export default {
  ...
  methods: {
    ...
    onDeleteMoney(row, index) {
      ...
      // 删除
      this.$axios.post('/delete', this.form).then((res) => {
        this.$message('删除成功')
        this.getProfile()
      })
    },
